  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#2d2d2d] flex flex-col items-center justify-center p-6 pb-20">
        ...
        <div className="w-full max-w-[90rem] bg-white shadow-xl rounded-2xl flex flex-col border-4 border-gray-100">
          ...
          <div id="checklist-footer" className="bg-slate-100 p-8 border-t border-gray-200 flex justify-between gap-6 rounded-b-xl shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
